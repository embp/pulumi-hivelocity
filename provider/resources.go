...
import (
	...
	hivelocity "github.com/hivelocity/terraform-provider-hivelocity/hivelocity"
...
const (
	...
	mainPkg = "hivelocity"
	// modules:
	mainMod = "index" // the hivelocity module
)

//go:embed cmd/pulumi-resource-hivelocity/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-hivelocity/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-hivelocity/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "hivelocity", hivelocity.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-hivelocity/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(hivelocity.Provider()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing hivelocity cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"embp", "hivelocity", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/embp/pulumi-hivelocity",
		// The GitHub Org for the provider - defaults to `terraform-providers`. Note that this should
		// match the TF provider module's require directive, not any replace directives.
		GitHubOrg:         "hivelocity",
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"hivelocity_device":               {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getDevice")},
			"hivelocity_product":              {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getProduct")},
			"hivelocity_device_initial_creds": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getDeviceInitialCreds")},
			"hivelocity_ssh_key":              {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getSshKey")},
			"hivelocity_effective_ignition":   {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getEffectiveIgnition")},
			"hivelocity_device_port":          {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getDevicePort")},
		},
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/embp/pulumi-hivelocity/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("hivelocity_", mainMod,
