...
{
    [Obsolete(@"hivelocity.index/baremetaldevice.bareMetalDevice has been deprecated in favor of hivelocity.index/baremetaldevicedetail.BareMetalDeviceDetail")]
    [HivelocityResourceType("hivelocity:index/bareMetalDevice:bareMetalDevice")]
    public partial class BareMetalDevice : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public BareMetalDevice(string name, BareMetalDeviceArgs args, CustomResourceOptions? options = null)
            : base("hivelocity:index/bareMetalDevice:bareMetalDevice", name, args ?? new BareMetalDeviceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BareMetalDevice(string name, Input<string> id, BareMetalDeviceState? state = null, CustomResourceOptions? options = null)
            : base("hivelocity:index/bareMetalDevice:bareMetalDevice", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BareMetalDevice Get(string name, Input<string> id, BareMetalDeviceState? state = null, CustomResourceOptions? options = null)
        {
            return new BareMetalDevice(name, id, state, options);
        }
    }

    public sealed class BareMetalDeviceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, prefer only bonded devices
        /// </summary>
        ...
        public BareMetalDeviceArgs()
        {
        }
        public static new BareMetalDeviceArgs Empty => new BareMetalDeviceArgs();
    }

    public sealed class BareMetalDeviceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, prefer only bonded devices
        /// </summary>
        ...
        public BareMetalDeviceState()
        {
        }
        public static new BareMetalDeviceState Empty => new BareMetalDeviceState();
    }
}
