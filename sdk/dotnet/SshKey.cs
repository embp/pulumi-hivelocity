...
{
    [Obsolete(@"hivelocity.index/sshkey.sshKey has been deprecated in favor of hivelocity.index/sshkeydetail.SshKeyDetail")]
    [HivelocityResourceType("hivelocity:index/sshKey:sshKey")]
    public partial class SshKey : global::Pulumi.CustomResource
    {
        ...
        public SshKey(string name, SshKeyArgs args, CustomResourceOptions? options = null)
            : base("hivelocity:index/sshKey:sshKey", name, args ?? new SshKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SshKey(string name, Input<string> id, SshKeyState? state = null, CustomResourceOptions? options = null)
            : base("hivelocity:index/sshKey:sshKey", name, state, MakeResourceOptions(options, id))
        {
        }
