...
func NewSshKey(ctx *pulumi.Context,
	...
	var resource SshKey
	err := ctx.RegisterResource("hivelocity:index/sshKey:sshKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSshKey(ctx *pulumi.Context,
	...
	var resource SshKey
	err := ctx.ReadResource("hivelocity:index/sshKey:sshKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o SshKeyOutput) SshKeyId() pulumi.IntOutput {
	return o.ApplyT(func(v *SshKey) pulumi.IntOutput { return v.SshKeyId }).(pulumi.IntOutput)
}
