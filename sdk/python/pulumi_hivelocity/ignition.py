...
warnings.warn("""hivelocity.index/ignition.ignition has been deprecated in favor of hivelocity.index/ignitiondetail.IgnitionDetail""", DeprecationWarning)
...
class Ignition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Ignition, __self__).__init__(
            'hivelocity:index/ignition:ignition',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            contents: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'Ignition':
        """
