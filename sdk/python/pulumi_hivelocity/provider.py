...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_key: Your API Key from the https://my.hivelocity.net portal.
        :param pulumi.Input[str] api_url: The API instance to communicate with defaults to https://core.hivelocity.net/api/v2
        """
