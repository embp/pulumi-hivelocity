...
warnings.warn("""hivelocity.index/sshkey.sshKey has been deprecated in favor of hivelocity.index/sshkeydetail.SshKeyDetail""", DeprecationWarning)
...
class SshKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SshKey, __self__).__init__(
            'hivelocity:index/sshKey:sshKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            public_key: Optional[pulumi.Input[str]] = None,
            ssh_key_id: Optional[pulumi.Input[int]] = None) -> 'SshKey':
        """
