...
warnings.warn("""hivelocity.index/vlan.vlan has been deprecated in favor of hivelocity.index/vlandetail.VlanDetail""", DeprecationWarning)
...
class Vlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port_ids: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            tag_id: Optional[pulumi.Input[int]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'Vlan':
        """
